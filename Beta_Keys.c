...
int main(void){
  long long int prime_number = 99991;    //prime_number → the prime modulus p
  long long int generator = 3;                        //generator → the number you are raising to a power.
  long long int hidden_num;                              //hidden_num → the exponent (your private key a).
  ...
  long long int public_key = ((long long int)pow(generator, hidden_num)) % prime_number;
    ...
    long long int secret_key = ((long long int)pow(public_key, hidden_num)) % prime_number;
